...
contract GSNRecipientERC20FeeUpgradeable is Initializable, GSNRecipientUpgradeable {
    function __GSNRecipientERC20Fee_init(string memory name, string memory symbol) internal {
        __Context_init_unchained();
        __GSNRecipient_init_unchained();
        __GSNRecipientERC20Fee_init_unchained(name, symbol);
    }

    function __GSNRecipientERC20Fee_init_unchained(string memory name, string memory symbol) internal {
...
contract __unstable__ERC20Owned is Initializable, ERC20Upgradeable, OwnableUpgradeable {
    ...
    function ____unstable__ERC20Owned_init_unchained(string memory name, string memory symbol) internal {
